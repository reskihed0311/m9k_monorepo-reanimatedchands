...
SWEP.Primary.Sound          = "Dmgfok_co1911.Single" -- Script that calls the primary fire sound
...
SWEP.IronSightsPos          = Vector( -2.977, -4.837, 0.56 )
SWEP.IronSightsAng          = Vector( 0, 0, 0 )
SWEP.SightsPos              = Vector( -2.977, -4.837, 0.56  )
